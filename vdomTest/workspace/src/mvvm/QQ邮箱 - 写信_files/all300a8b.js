...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor2f0ce8.js"]);
...
{
var B=(/<!--cgierrorcode:-([\d]+)-->/ig.test(y)&&RegExp.$1);
if("821"==B)
{
showError("\u5BF9\u65B9\u5DF2\u505C\u6B62\u5171\u4EAB\u65E5\u5386");
}
...
{
var d=/^https?:\/\/(?:([\w]+)\.)?mail\.qq\.com(\/)/i.test(c)&&RegExp.$1||"mail";
...
b.LogKV("getcontenturl|domain|"+d);
}
}
...
var a={'comm2010.css':'$css_path$comm20103009eb.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
